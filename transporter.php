      ...
      <div class="modal-body">
        <form action="transporter.php" method="post" name="add-new-transporter">
            ...
            <div class="row align-items-end">
              <div class="col-md-6">
                <label>Transporter Name</label> <input class="form-control" name="trans_company" type="text">
              </div>


              <div class="col-md-6">
                <label>Contact Name</label> <input class="form-control" name="trans_company_contact" type="text">
              </div>
            </div>
            ...
            <div class="row align-items-end">
              <div class="col-md-3">
                <label>Phone</label> <input class="form-control" name="trans_company_phone" type="tel">
              </div>
              ...
              <div class="col-md-6">
                <label>Email</label> <input class="form-control" name="trans_company_email" type="email">
              </div>
            </div>
        </form>
      </div>
