      ...
      <div class="modal-body">
        <form action="exporter.php" method="post" name="add-new-exporter">
            ...
            <div class="row align-items-end">
              <div class="col-md-6">
                <label>Exporter (Shipper)</label> <input class="form-control" name="exp_owner" type="text">
              </div>


              <div class="col-md-6">
                <label>Contact Name</label> <input class="form-control" name="exp_contact" type="text">
              </div>
            </div>
            ...
            <div class="row align-items-end">
              <div class="col-md-3">
                <label>Phone</label> <input class="form-control" name="exp_phone" type="tel">
              </div>
            ...
            <div class="row align-items-end">
              ...
              <div class="col-md-9">
                <label>Address</label> <input class="form-control" name="exp_address" type="text">
              </div>
            </div>
            ...
            <div class="row align-items-end">
              <div class="col-md-3">
                <label>City</label> <input class="form-control" name="exp_city" type="text">
              </div>


              <div class="col-md-3">
                <label>State/Province</label> <select class="form-control" name="exp_state">
                  <option>
                  </option>
                </select>
              </div>
              ...
              <div class="col-md-3">
                <label>Zip/Postal Code</label> <input class="form-control" name="exp_postal_code" type="text">
              </div>
